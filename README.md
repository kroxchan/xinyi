...
### 方式一：安装包（macOS / Windows）（持续更新中，不太稳定）
...
**界面与 Tab 说明**（每个标签页做什么、推荐操作顺序、配图）：见 **[使用说明](docs/使用说明.md)**。
...
- **RAG 重排**：向量检索后经 BAAI/bge-reranker-base 重排，优先召回与当前语境最匹配的对话片段（先召回 20 条，重排后取前 5 条）
  ![img_v3_0210a_362b7adc-01fa-47f1-81cb-95efe10a7c0g](https://github.com/user-attachments/assets/9517618d-0991-4056-8e6a-e8d3741ed502)
...
![img_v3_0210a_053e15cd-4968-4eec-8f43-070c089b09fg](https://github.com/user-attachments/assets/385b8c9d-928d-420b-88e2-81f08c86a64d)
...
![img_v3_0210a_6975fe6b-f696-438a-8e8f-dd47da4680eg](https://github.com/user-attachments/assets/5cd46640-17c6-4d47-9aa8-9d632bf6e834)
...
![img_v3_0210a_e6b5fec4-0fd6-4ea1-ba20-5875ee07095g](https://github.com/user-attachments/assets/a92b1ba5-d306-494a-b859-99dc14335dc1)
![img_v3_0210a_b62f5fd4-39e9-4fbd-aa51-caa1a859753g](https://github.com/user-attachments/assets/40ce0d01-cefd-4ab0-924a-4c0c3ec6fb13)
...
| CI | `.github/workflows/build.yml` | push `main` 构建 macOS/Windows _zip 并更新 Release（使用仓库默认 `GITHUB_TOKEN` 或配置 PAT Secret） |
...
| Release 无新包 / CI 红 | 权限或构建失败 | 确认 Workflow 有 **`contents: write`**；默认 `GITHUB_TOKEN` 通常足够；在 **Actions** 页查看失败 job 日志 |
